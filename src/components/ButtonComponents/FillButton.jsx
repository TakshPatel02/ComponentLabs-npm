...
export const FillButton = ({
  ...
  return (
    <>
      <button
        onClick={onClick}
        className={`cl-fill-btn relative px-8 py-3.5 font-['Space_Grotesk',sans-serif] text-[13px] font-medium tracking-widest uppercase border border-[#11100a] dark:border-[#fdf8f7] text-[#11100a] dark:text-[#fdf8f7] overflow-hidden group/btn active:scale-[0.98] transition-transform ${className}`}
      >
